...
sealed class Screen(val route: String, var title: String) {
    ...
    object PublicProfilesTableScreen: Screen("public_profiles_table_screen", "Public Profiles")
    object PublicProfileScreen: Screen("public_profile_screen", "Public Profile")
    object PublicProfileReviewsScreen: Screen("public_profile_reviews_screen", "Profile Reviews")
    object PublicProfileListsScreen: Screen("public_profile_lists_screen", "Profile Lists")
    ...
    object PublicListScreen: Screen("public_list_screen", "Public List")
